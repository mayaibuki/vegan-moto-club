...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        <h1 className="text-4xl font-heading font-bold mb-2">About Vegan Moto Club</h1>
      ...
      <Card>
        <CardContent className="pt-6 space-y-6 text-lg">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-3">Why Vegan Gear?</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-3">Our Community</h2>
            <p className="text-muted-foreground">
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          <div className="space-y-3 text-muted-foreground">
            <p>
              <strong>Found a great vegan brand?</strong> Submit it through our
              product suggestion form on the home page.
            </p>
            <p>
              <strong>Have questions?</strong> Reach out to us on Discord or through
              our social media channels.
            </p>
            <p>
              <strong>Want to contribute?</strong> We're always looking for community
